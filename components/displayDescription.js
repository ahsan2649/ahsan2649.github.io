app.component("displaydescription", {
  ...
  template:
    /*html*/
    `<div id="description"><p v-html="descriptions[this.selecteditem]"></p></div>`,
  data() {
    return {
      descriptions: [
        /*html*/
        ...
        For this particular scene, the 8 frequency bands are input into 8 colored columns, and the amplitude is input into the color of the material and light emitting from the spinning spheres. The result is a satisfying animation with coherence to the playing audio.`,
        /*html*/
        `Poi-duino 2.0 is a project that combines sound with lighting through Arduino code. The design for the project, as well as the calculations for the resistance was done by two of my classmates. The assembly and coding was done by myself.
        ...
        /*html*/
        `Typo-logy is a typing game I made for myself in Unity to practice Dvorak typing. It takes in a given exercise string, and outputs each character at a specific pace, to be typed within a specific time limit. The characters appear as simple text on top of a simple sprite. Scores are tallied based on correct and incorrect keypresses.`,
        /*html*/
